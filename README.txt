...
- Ran generate-eval-dataset.py to invoke the flow programmatically and generated the test output file output_eval_dataset.jsonl.
...
- 01_full_flow_diagram.png: Complete Bedrock flow diagram showing all nodes, connections, and saved state.
- 02_classifier_condition.png: Configuration panel showing the Condition node expressions and classifier prompt.
- 03_agent_lambda_binding.png: Lambda console showing create-bug-report function configuration.
- 04_dynamodb_bug_record.png: DynamoDB table showing a bug report ticket created by the application.
- 05_bedrock_eval_results.png: Bedrock Flow test trace showing a live prompt execution and node completion steps.
- 06_testflow_screenshot.png: Flow test conversation capture.
